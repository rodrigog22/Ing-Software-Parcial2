...
public class CabeceraFacturaController {
    ...
    public CabeceraFacturaEntity create(@RequestBody(required = true) CabeceraFacturaEntity newCabeceraFactura) {
        return this.facturaService.createCabeceraFactura(newCabeceraFactura);
    }
